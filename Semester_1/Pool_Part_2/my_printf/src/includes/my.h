...
char *my_pivot_add_nbr(va_list args, char **temp_buffer, char *buffer);
char *my_fake_pivot_add_nbr(intmax_t nb, char **temp_buffer, char *buffer);
char *my_pivot_add_nbr_u(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_nbr_o(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_nbr_x(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_nbr_x_maj(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_addstr(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_addchar(va_list args, char **temp_buffer, char *buffer);
char *my_add_percent(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_float(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_scientific(va_list args, char **temp_buffer, char *buffer);
char *my_pivot_add_scientific_maj(va_list args, char **temp_buffer, char *buff);
...
char *my_pivot_add_g(va_list args, char **other_args, char *buffer);
...
char *my_add_nbr_ndigits(int nb, int precision, char *buffer);
