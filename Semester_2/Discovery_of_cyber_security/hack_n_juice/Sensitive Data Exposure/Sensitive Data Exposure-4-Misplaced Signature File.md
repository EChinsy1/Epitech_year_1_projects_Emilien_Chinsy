# Misplaced Signature Files 4*:

## Description of the challenge:
Access a misplaced SIEM signature file. (Difficulty Level: 4)
...
- 2: Go to https://ctf.juice.cyber.epitest.eu/ftp and find suspicious_errors.yml
